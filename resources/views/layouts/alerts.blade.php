    ...
    <div class="container-fluid g-0 p-0">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 mb-30">
                @if (session()->has('info'))
                    <div class="alert alert-primary alert-dismissible fade show mb-n2 auto-close" role="alert">
                ...
                @elseif (session()->has('success'))
                    <div class="alert alert-success alert-dismissible fade show mb-n2 auto-close" role="alert">
                ...
                @elseif (session()->has('warning'))
                    <div class="alert alert-warning alert-dismissible fade show mb-n2 auto-close" role="alert">
                ...
                @elseif (session()->has('danger'))
                    <div class="alert alert-danger alert-dismissible fade show mb-n2 auto-close" role="alert">
