<div class="tab-content p-0">
    {{-- For new request --}}
    <div class="tab-pane fade @if ($order->type == 'paper_media') active show @endif" id="navs-top-home" role="tabpanel">
        <form id="paper_media_form" action="{{ route('orders.update', ['id' => $order->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-block mb-2">
                                            ...
                                            <select name="distributionType" id="distributionType" required
                                                ...
                                                <option @if ($order->distribution_type == 'all') selected @endif
                                                    value="all">All</option>
                                                <option @if ($order->distribution_type == 'residential') selected @endif
                                                    value="residential">Residential</option>
                                                <option @if ($order->distribution_type == 'commerical') selected @endif
                                                    value="commerical">Commerical</option>
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-select select2" name="paper" id="paper" required
                                                ...
                                                @foreach ($paper_for_paper_media as $type)
                                                    <option value="{{ $type->id }}"
                                                        {{ isset($order->paper_type_id) && $order->paper_type_id == $type->id ? 'selected' : '' }}>
                                                        {{ $type->name }}
                                        ...
                                        <div class="d-block mb-2">
                                            ...
                                            {{-- onbeforeunload="getAttributesOfPaperType()" --}}
                                        ...
                                        <div class="d-block mb-2">
                                            ...
                                            <select name="distributionDuaration" id="distributionDuaration"
                                                ...
                                                <option @if ($order->duration == 'One Day') selected @endif
                                                    value="One Day">One Day</option>
                                                <option @if ($order->duration == 'Two Days') selected @endif
                                                    value="Two Days">Two Days</option>
                                                <option @if ($order->duration == 'Three Days') selected @endif
                                                    value="Three Days">Three Days</option>
                                                <option @if ($order->duration == 'One Week') selected @endif
                                                    value="One Week">One Week</option>
                                            </select>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="d-block mb-2">
                                            ...
                                            <input type="number" readonly name="no_of_copies" id="no_of_copies"
                                                {{-- value="{{ isset($order->total_copies) ? $order->total_copies : '' }}" --}}
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="d-block mb-2 text-center">
                                            <a class="btn btn-primary mb-2 text-nowrap cursor-pointer text-white"
                                                href="javascript:void(0)" onclick="movePMNext()">Next</a>
                                        </div> --}}
                                    </div>
                                    {{-- Modal for design --}}
                                ...
                                <div class="row">
                                    <div class="classic col col-sm-4 col-lg-4">
                                        ...
                                        <input type="color" class="form-control form-control-color"
                                            value="{{ isset($order->primary_color) ? $order->primary_color : '' }}"
                                    ...
                                    <div class="monolith col col-sm-4 col-lg-4">
                                        ...
                                        <input type="color" class="form-control form-control-color"
                                            value="{{ isset($order->secondary_color) ? $order->secondary_color : '' }}"
                                    ...
                                    <div class="nano col col-sm-4 col-lg-4">
                                        <label for="tertiary_color">Tertiary Color
                                            <span class="text-danger">*</span></label>
                                        <input type="color" class="form-control form-control-color"
                                            value="{{ isset($order->tertiary_color) ? $order->tertiary_color : '' }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <input id="pm_attachments" type="file" required
                                        {{-- value="{{ $order->getFirstMediaUrl('order_attachments') }}" --}}
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <textarea placeholder="Enter Your Details Here..." class="form-control" required name="comments" id="comments"
                                        rows="3">{{ isset($order->comments) ? $order->comments : '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @if ($order->type == 'vehicle_media') active show @endif" id="navs-top-profile"
        role="tabpanel">
        <form id="vehicle_media_form" action="{{ route('orders.update', ['id' => $order->id]) }}" method="post"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="d-block mb-2">
                                            ...
                                            <select name="routes[]" id="routes" class="form-select select2"
                                                ...
                                                @foreach ($routes as $route)
                                                    <option @if (in_array($route->id, $selected_routes)) selected @endif
                                        ...
                                        <div class="d-block mb-2">
                                            ...
                                            <select name="adDuaration" id="adDuaration" class="form-select select2"
                                                ...
                                                <option value="">Please Select</option>
                                                <option
                                                    {{ isset($order->duration) && $order->duration == 'Half Month' ? 'selected' : '' }}
                                                    value="Half Month">15 Days</option>
                                                <option
                                                    {{ isset($order->duration) && $order->duration == 'One Month' ? 'selected' : '' }}
                                                    value="One Month">One Month</option>
                                                <option
                                                    {{ isset($order->duration) && $order->duration == 'Two Month' ? 'selected' : '' }}
                                                    value="Two Month">Two Month</option>
                                                <option
                                                    {{ isset($order->duration) && $order->duration == 'Three Month' ? 'selected' : '' }}
                                                    value="Three Month">Three Month</option>
                                                <option
                                                    {{ isset($order->duration) && $order->duration == 'Six Month' ? 'selected' : '' }}
                                                    value="Six Month">Six Month</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="d-block mb-2 text-center">
                                            <a class="btn btn-primary mb-2 text-nowrap cursor-pointer text-white"
                                                href="javascript:void(0)" onclick="moveVMNext()">Next</a>
                                        </div> --}}
                                    </div>
            ...
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <div
                        ...
                        <h6 class="m-0 mb-2 mb-sm-0">Car Type</h6>
                        <div class="d-flex flex-wrap gap-2">
                            <p>Suzuki</p>
                        </div>
                    </div>
                    ...
                    <div
                        class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between border-bottom pb-3 mb-3">
                        <h6 class="m-0 mb-2 mb-sm-0">Total Price</h6>
