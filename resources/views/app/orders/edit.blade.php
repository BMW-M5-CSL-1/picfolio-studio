...
@section('seo-breadcrumb')
    <h4 class="fw-bold py-3 mb-4 ">
        <span class="text-muted fw-light">
            {{ Breadcrumbs::view('breadcrumbs::json-ld', 'orders.edit') }}
        </span>
    </h4>
@endsection
    ...
    <div class="content-header-left col-md-9 col-12">
        <div class="row breadcrumbs-top mb-0">
            <div class="col-12 align-items-center d-flex">
                <h2 class="content-header-title float-start mb-0">Edit Order</h2>
...
@section('content')
    <div class="row g-4 mb-4">
        <div class="col-sm-12 col-xl-12">
                                ...
                                <ul class="c_btns nav-tabs border-0 ps-0" role="tablist">
                                    <li class="d-block nav-item w-50 mx-2" role="presentation">
                                        <div class="card p-0 border-0 h-100">
                                            ...
                                            <div class="card-body p-0 border-0">
                                                <button type="button"
                                                    class="h-100 nav-link @if ($order->type == 'paper_media') active @endif  p-4"
                                                    @if ($order->type == 'vehicle_media') disabled @endif role="tab"
                                    ...
                                    <li class="c_li_2 d-block nav-item w-50 mx-2" role="presentation">
                                        <div class="card p-0 border-0 h-100 ">
                                            <div class="card-body p-0 border-0">
                                                <button type="button"
                                                    class="h-100 nav-link @if ($order->type == 'vehicle_media') active @endif p-4"
                                                    @if ($order->type == 'paper_media') disabled @endif role="tab"
            ...
            {{ view('app.orders.edit-form-fields', [
                'order' => $order,
...
@section('page-script')
    ...
    @include('app.orders.edit-scripts')
@endsection
